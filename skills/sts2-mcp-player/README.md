...
- 技能主说明：
  [SKILL.md](<repo-root>/skills/sts2-mcp-player/SKILL.md)
- 分 screen 剧本：
  [screen-playbooks.md](<repo-root>/skills/sts2-mcp-player/references/screen-playbooks.md)
- 调试与验证说明：
  [debug-and-validation.md](<repo-root>/skills/sts2-mcp-player/references/debug-and-validation.md)
- UI metadata：
  [openai.yaml](<repo-root>/skills/sts2-mcp-player/agents/openai.yaml)
