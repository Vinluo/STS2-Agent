...
- [api.md](<repo-root>/docs/api.md)
- [roadmap-current.md](<repo-root>/docs/roadmap-current.md)
- [phase-4c-shop.md](<repo-root>/docs/phase-4c-shop.md)
- [phase-5-full-chain.md](<repo-root>/docs/phase-5-full-chain.md)
- [phase-6-validation-template.md](<repo-root>/docs/phase-6-validation-template.md)
- [phase-6-validation-2026-03-11.md](<repo-root>/docs/phase-6-validation-2026-03-11.md)
- [mcp_server/README.md](<repo-root>/mcp_server/README.md)
